...
// generator /home/runner/work/zig-opengl/zig-opengl/bin/Debug/net6.0/generator.dll OpenGL-Registry/xml/gl.xml exports/gl_4v6.zig GL_VERSION_4_6
//
...
pub fn specializeShader(_shader: GLuint, _pEntryPoint: [*c]const GLchar, _numSpecializationConstants: GLuint, _pConstantIndex: [*c]const GLuint, _pConstantValue: [*c]const GLuint) callconv(.C) void {
    return (function_pointers.glSpecializeShader orelse @panic("glSpecializeShader was not bound."))(_shader, _pEntryPoint, _numSpecializationConstants, _pConstantIndex, _pConstantValue);
}
...
pub fn multiDrawArraysIndirectCount(_mode: GLenum, _indirect: ?*const anyopaque, _drawcount: GLintptr, _maxdrawcount: GLsizei, _stride: GLsizei) callconv(.C) void {
    return (function_pointers.glMultiDrawArraysIndirectCount orelse @panic("glMultiDrawArraysIndirectCount was not bound."))(_mode, _indirect, _drawcount, _maxdrawcount, _stride);
}
...
pub fn multiDrawElementsIndirectCount(_mode: GLenum, _type: GLenum, _indirect: ?*const anyopaque, _drawcount: GLintptr, _maxdrawcount: GLsizei, _stride: GLsizei) callconv(.C) void {
    return (function_pointers.glMultiDrawElementsIndirectCount orelse @panic("glMultiDrawElementsIndirectCount was not bound."))(_mode, _type, _indirect, _drawcount, _maxdrawcount, _stride);
}

pub fn polygonOffsetClamp(_factor: GLfloat, _units: GLfloat, _clamp: GLfloat) callconv(.C) void {
    return (function_pointers.glPolygonOffsetClamp orelse @panic("glPolygonOffsetClamp was not bound."))(_factor, _units, _clamp);
}
// Extensions:
...
pub fn load(load_ctx: anytype, get_proc_address: fn (@TypeOf(load_ctx), [:0]const u8) ?FunctionPointer) !void {
    ...
    if (get_proc_address(load_ctx, "glSpecializeShader")) |proc| {
        function_pointers.glSpecializeShader = @ptrCast(@TypeOf(function_pointers.glSpecializeShader), proc);
    } else {
        log.err("entry point glSpecializeShader not found!", .{});
        success = false;
    }
    if (get_proc_address(load_ctx, "glMultiDrawArraysIndirectCount")) |proc| {
        function_pointers.glMultiDrawArraysIndirectCount = @ptrCast(@TypeOf(function_pointers.glMultiDrawArraysIndirectCount), proc);
    } else {
    ...
    if (get_proc_address(load_ctx, "glMultiDrawElementsIndirectCount")) |proc| {
        function_pointers.glMultiDrawElementsIndirectCount = @ptrCast(@TypeOf(function_pointers.glMultiDrawElementsIndirectCount), proc);
    } else {
        log.err("entry point glMultiDrawElementsIndirectCount not found!", .{});
        success = false;
    }
    if (get_proc_address(load_ctx, "glPolygonOffsetClamp")) |proc| {
        function_pointers.glPolygonOffsetClamp = @ptrCast(@TypeOf(function_pointers.glPolygonOffsetClamp), proc);
    } else {
...
const function_pointers = struct {
    ...
    var glSpecializeShader: ?FnPtr(function_signatures.glSpecializeShader) = null;
    var glMultiDrawArraysIndirectCount: ?FnPtr(function_signatures.glMultiDrawArraysIndirectCount) = null;
    var glMultiDrawElementsIndirectCount: ?FnPtr(function_signatures.glMultiDrawElementsIndirectCount) = null;
    var glPolygonOffsetClamp: ?FnPtr(function_signatures.glPolygonOffsetClamp) = null;
};
